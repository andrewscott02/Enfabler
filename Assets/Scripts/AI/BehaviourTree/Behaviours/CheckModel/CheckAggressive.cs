...
public class CheckAggressive : Node
{
    ...
    public CheckAggressive(ConstructPlayerModel characterModel)
    {
    ...
    public override NodeState Evaluate()
    {
        ...
        {
            if (characterModel.playerState == Descriptor.Aggressive) { state = NodeState.Success; }
        }
