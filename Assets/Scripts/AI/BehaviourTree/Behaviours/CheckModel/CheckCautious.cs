...
public class CheckCautious : Node
{
    ...
    public CheckCautious(ConstructPlayerModel characterModel)
    {
    ...
    public override NodeState Evaluate()
    {
        ...
        {
            if (characterModel.playerState == Descriptor.Cautious) { state = NodeState.Success; }
        }
