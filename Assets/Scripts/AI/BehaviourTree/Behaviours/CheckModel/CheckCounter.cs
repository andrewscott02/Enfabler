...
public class CheckCounter : Node
{
    ...
    public CheckCounter(ConstructPlayerModel characterModel)
    {
    ...
    public override NodeState Evaluate()
    {
        ...
        {
            if (characterModel.playerState == Descriptor.Counter) { state = NodeState.Success; }
        }
